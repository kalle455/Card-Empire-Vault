...
export default function AdminDashboard() {
  ...
  async function deleteCard(id, name) {
    if (!window.confirm(`Remove ${name} from the Card Vault?`)) return;
